...
public class PanelCashierController implements Initializable {
    ...
    private void handleActionButtons(ActionEvent event) {
        if (event.getSource() == btnDashboard) {
            changeCenterPanel("/com/qb/app/cashier/cashierDashboard.fxml", "Dashboard");
            ...
            if (ApplicationSession.getSession() != null) {
                if (ApplicationSession.getSession().getStatus().equals("ON")) {
                    changeCenterPanel("/com/qb/app/cashier/cashierInvoice.fxml", "Invoice");
                } else {
            ...
            if (closeSaleAvailable()) {
                if (ApplicationSession.getSession() != null && ApplicationSession.getSession().getStatus().equals("OFF")) {
                    changeCenterPanel("/com/qb/app/cashier/cashierCloseSale.fxml", "Close Sale");
                } else {
...
//            showPermissionMessage();
    ...
    private void setDefaultPanel() {
        try {
            FXMLLoader dashboard = new FXMLLoader(getClass().getResource("/com/qb/app/cashier/cashierDashboard.fxml"));
